...
body {
  margin-top: 40px;
  color: rgb(46,46,46);
  background: url('/images/absolutemini-bg.png') no-repeat top right;
}
...
@media screen and (min-width: 768px) {
  ...
  .footer {
    ...
    <!-- Google tag (gtag.js) -->
    <script async src="https://www.googletagmanager.com/gtag/js?id=G-L6DWWZKS0L"></script>
    <script>
      window.dataLayer = window.dataLayer || [];
      function gtag(){dataLayer.push(arguments);}
      gtag('js', new Date());

      gtag('config', 'G-L6DWWZKS0L');
    </script>
    <body>
